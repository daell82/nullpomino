...
public class TimeMenuItem extends IntegerMenuItem {
	...
	public TimeMenuItem(String name, String displayName, int color, int defaultValue, int min, int max) {
		super(name, displayName, color, defaultValue, min, max);
		increment = 60;
	}

	public TimeMenuItem(String name, String displayName, int color, int defaultValue, int min, int max, int increment) {
		super(name, displayName, color, defaultValue, min, max);
