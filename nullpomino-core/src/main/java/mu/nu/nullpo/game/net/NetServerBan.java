...
public class NetServerBan {
	...
	public static final int BANLENGTH_6HOURS = 1;
	public static final int BANLENGTH_24HOURS = 2;
	public static final int BANLENGTH_1WEEK = 3;
	public static final int BANLENGTH_1MONTH = 4;
	public static final int BANLENGTH_1YEAR = 5;
	public static final int BANLENGTH_PERMANENT = 6;
