...
public abstract class AbstractMenuItem<T> {
	 ...
	 *
	 * @param dir  Direction pressed: -1 = left, 1 = right. If 0, update without
	 *             changing any settings.
	 * @param fast 0 by default, +1 if E held, +2 if F held.
	 */
	public abstract void change(int dir, int fast);

	public abstract void save(int playerID, CustomProperties prop, String modeName);

	public abstract void load(int playerID, CustomProperties prop, String modeName);
}
