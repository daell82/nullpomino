...
public class RanksResult extends JDialog implements ActionListener, PropertyChangeListener {
	...
	class SurfaceComparator implements Comparator<Integer> {
		...
		public int compare(Integer o1, Integer o2) {
			...
			if ((factorCompare * (ranks.getRankValue(o2.intValue()))) > (factorCompare
					* ranks.getRankValue(o1.intValue()))) {
				return 1;
			} else if ((factorCompare * (ranks.getRankValue(o2.intValue()))) < (factorCompare
					* ranks.getRankValue(o1.intValue()))) {
				return -1;
			} else {
				return 0;
	...
	private void initUI() {
		...
		labelScoreMirrored = new JLabel(
				AIRanksTool.getUIText("Result_Score") + surfaceRanksBestsMirrored[indexSurface].getRank());
	...
	public void propertyChange(PropertyChangeEvent evt) {
		if ("progress" == evt.getPropertyName()) {
			...
			String message = String.format(AIRanksTool.getUIText("Result_Progress_Note"), progress);
