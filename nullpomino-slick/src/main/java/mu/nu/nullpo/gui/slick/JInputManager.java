...
public class JInputManager {
	...
	/** Keysym map */
	public static Map<Integer, Component.Identifier.Key> keyMap;
	...
	public static void initKeyboard() {
		var cEnv = ControllerEnvironment.getDefaultEnvironment();
		for (Controller c : cEnv.getControllers()) {
			if(c.getType() == Controller.Type.KEYBOARD && c instanceof Keyboard kb) {
